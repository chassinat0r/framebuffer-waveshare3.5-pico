...
class FrameBuffer {
	public:
		...
		void fill(COLOR c);
		void fill_rect(int x_start, int y_start, int w, int h, COLOR c);
		...
		void rect(int x_start, int y_start, int w, int h, COLOR c);
		
		void text(char *string, int x, int y, COLOR c);

		int width = 480;
		int height = 160;
		int stride = width;

		uint8_t buffer[480*160*2];
